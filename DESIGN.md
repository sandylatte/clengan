...
colors:
  ...
  peach-primary: "#9D4D6B"
  peach-primary-hover: "#AE5B7A"
  peach-on-primary: "#FFFFFF"
  peach-active: "#973B5D"
  peach-accent: "#2D6D4D"
  peach-destructive: "#B3332A"
  peach-background: "#EFD9E1"
  peach-foreground: "#452531"
  peach-muted: "#F3E6EB"
  peach-input: "#F6EEF1"
  peach-subtle: "#845466"
  peach-border: "#E1C6D2"
  peach-border-strong: "#CFA9BC"
  tabbar: "color-mix(in srgb, var(--color-muted) 92%, transparent)"
  peach-tabbar: "#E8CDD8"
  scrim: "rgb(0 0 0 / 0.72)"
  peach-scrim: "rgb(69 37 49 / 0.34)"
  peach-bar: "#E3C3D1"

shadows:
  primary-graphite: "none"
  primary-peach: "0 1px 2px rgba(69,37,49,0.16)"
  popover-graphite: "0 10px 30px rgba(0,0,0,0.85), 0 0 0 1px rgba(20,40,30,0.9)"
  popover-peach: "0 12px 32px rgba(69,37,49,0.18), 0 2px 8px rgba(69,37,49,0.10)"
